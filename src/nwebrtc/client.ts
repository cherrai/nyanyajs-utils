...
export class NWebRTCClient extends NEventListener<{
  ...
  public async getUserMedia(constraints?: MediaStreamConstraints) {
    return await navigator?.mediaDevices?.getUserMedia(constraints)
  }
  public async getDisplayMedia(options?: DisplayMediaStreamConstraints) {
