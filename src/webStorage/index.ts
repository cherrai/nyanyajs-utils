...
// import { QueueLoop, AsyncQueue } from '@nyanyajs/utils'
...
export class WebStorage<K = string, T = any> {
        ...
        switch (this.storage) {
          ...
          case 'IndexedDB':
            WebStorage.model
              ...
              .Result()
              .then((res) => {
                // console.log("GetTripHistoryPositions ws", res)
  ...
  public async mset(params: {
    ...
    for (let i = 0; i < params.length; i++) {
      const v = params[0]
      await this.set(v.key, v.value, v.expiration || 0)
    }
